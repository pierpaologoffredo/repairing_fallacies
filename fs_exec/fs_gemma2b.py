...
if parse_args.no_ctx:
    data_path = "./data/gemma_data/few_shot_gemma_no_ctx_lab.txt"
else:
    data_path = "./data/gemma_data/few_shot_gemma_lab.txt"
...
with open(data_path, "r", encoding='utf-8') as data:
    ...
    for prompt in tqdm(data_lines):
        ...
        outputs = model.generate(**inputs, max_new_tokens=512, num_return_sequences=1, temperature=0.5)
...
path_res = "./fs_results/"
if parse_args.no_ctx:
    file_res = "{}_fs_results_no_ctx_lab.csv".format(modelName)
else:
    file_res = "{}_fs_results_lab.csv".format(modelName)
