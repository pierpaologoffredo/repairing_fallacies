...
if parse_args.no_ctx:
    data_path = "./data/gpt_data/few_shot_gpt_no_ctx_lab.jsonl"
else:
    data_path = "./data/gpt_data/few_shot_gpt_lab.jsonl"
...
path_res = "./fs_results/"
if parse_args.no_ctx:
    file_res = "{}_fs_results_no_ctx_lab.csv".format(model_name)
else:
    file_res = "{}_fs_results_lab.csv".format(model_name)
